...
- The database is configured with SQLite and schema synchronization is enabled only when `NODE_ENV === 'development'` (or an equivalent local development flag); production should use migrations with synchronize disabled.
