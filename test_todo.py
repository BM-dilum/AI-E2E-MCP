...
class TestTodo(unittest.TestCase):
    """Test cases for todo task management functions."""

    def test_add_task_adds_a_task_correctly(self):
        """Verify that adding a task appends the expected task structure."""
        task_list = []
    ...
    def test_list_tasks_returns_all_tasks(self):
        """Verify that listing tasks returns the full task list unchanged."""
        task_list = [
            {"task": "Buy milk", "completed": False},
